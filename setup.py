...
'''
    ...
    $FileInfo: setup.py - Last Update: 1/22/2018 Ver. 1.0.0 RC 1 - Author: cooldude2k $
'''
...
verinfofilename = os.path.realpath("."+os.path.sep+os.path.sep+"gm2kenc.py")
...
pymodule['description'] = 'A little encrypter I made a long time ago.'
pymodule['license'] = 'Revised BSD License'
pymodule['keywords'] = 'encrypter pyencrypter python python-encrypter'
pymodule['url'] = 'https://github.com/GameMaker2k/PyEncrypter'
pymodule['downloadurl'] = 'https://github.com/GameMaker2k/PyEncrypter/archive/master.tar.gz'
pymodule['longdescription'] = 'A little encrypter I made a long time ago.'
pymodule['platforms'] = 'OS Independent'
pymodule['zipsafe'] = True
pymodule['pymodules'] = ['gm2kenc']
