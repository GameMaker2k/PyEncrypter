...
def GM2k_Decrypt(matches):
 ...
 Change12 = ["Ã", "Ä", "Å", "Æ", "Ç", "È", "É", "Ê", "Ë", "Ì", "Í", "Î", "Ï", "Ð", "Ñ", "Ò", "Ó", "Ô", "Õ", "Ö", "×", "Ø", "Ù", "Ú", "Û", "Ü", "Ý", "þ", "ß"];
 Change11 = ["#(20)", "#(40)", "#(21)", "#(41)", "#(22)", "#(42)", "#(23)", "#(43)", "#(24)", "#(44)", "#(25)", "#(45)", "#(26)", "#(46)", "#(27)", "#(47)", "#(28)", "#(48)", "#(29)", "#(49)", "#(30)", "#(50)", "#(31)", "#(51)", "#(32)", "#(53)", "#(33)", "#(54)", "#(34)"];
 Change14 = ["à", "á", "â", "ã", "ä", "å", "æ", "ç", "è", "é", "ê", "ë", "ì", "í", "î", "ï", "ð", "ñ", "ò", "ó", "ô", "õ", "ö", "÷", "ø", "ù", "ú", "û", "ü", "ý", "Þ", "ÿ"];
 ...
 Change24 = ["Ck", "ck", "Ne", "ne", "Né", "né", "Ló", "ló", "Lo", "lo", "Fo", "fo", "Su", "su", "Dis", "dis", "Us", "us", "Zy", "zy", "Si", "si", "Po", "po", "Mo", "mo", "GM", "gm", "CD", "cd"];
...
def GM2k_Encrypt1(matches):
 ...
 Change11 = ["Ã", "Ä", "Å", "Æ", "Ç", "È", "É", "Ê", "Ë", "Ì", "Í", "Î", "Ï", "Ð", "Ñ", "Ò", "Ó", "Ô", "Õ", "Ö", "×", "Ø", "Ù", "Ú", "Û", "Ü", "Ý", "þ", "ß"];
 Change12 = ["#(20)", "#(40)", "#(21)", "#(41)", "#(22)", "#(42)", "#(23)", "#(43)", "#(24)", "#(44)", "#(25)", "#(45)", "#(26)", "#(46)", "#(27)", "#(47)", "#(28)", "#(48)", "#(29)", "#(49)", "#(30)", "#(50)", "#(31)", "#(51)", "#(32)", "#(53)", "#(33)", "#(54)", "#(34)"];
 Change13 = ["à", "á", "â", "ã", "ä", "å", "æ", "ç", "è", "é", "ê", "ë", "ì", "í", "î", "ï", "ð", "ñ", "ò", "ó", "ô", "õ", "ö", "÷", "ø", "ù", "ú", "û", "ü", "ý", "Þ", "ÿ"];
 ...
 Change23 = ["Ck", "ck", "Ne", "ne", "Né", "né", "Ló", "ló", "Lo", "lo", "Fo", "fo", "Su", "su", "Dis", "dis", "Us", "us", "Zy", "zy", "Si", "si", "Po", "po", "Mo", "mo", "GM", "gm", "CD", "cd"];
